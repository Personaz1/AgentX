...
1. ❌ **Автономность** - агент не полностью управляет средой:
   ...
   - Необходима интеграция с системой управления окружением
...
#### Задачи:
1. **Разработать интерфейс терминала в окне чата** 🔄 (в процессе)
...
## Приоритеты на следующие 2 недели (20.04-04.05.2025)
...
2. **Интеграция встроенного терминала в интерфейс чата** 🔝
